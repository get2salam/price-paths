  ...
  "slug": "price-paths",
  "title": "Price Paths",
  "tagline": "Sketch pricing experiments and compare which paths feel strongest.",
  "domainLabel": "paths",
  "itemLabel": "path",
  "emptyTitle": "No pricing paths yet",
  "emptyBody": "Map the packages or experiments you want to compare.",
  "seedTitle": "Pricing experiment board",
  "seedSubtitle": "A direct little lab for pricing ideas, not a spreadsheet maze.",
  "categories": [
    "Entry",
    "Core",
    "Premium",
  ...
  "items": [
    {
      ...
      "score": 8,
      "effort": 2,
      "note": "Good for trust-building if it naturally leads to the higher-value offer."
    },
    {
      "title": "Research partner plan",
      "category": "Premium",
      "state": "Hypothesis",
      "score": 9,
      "effort": 4,
      "note": "High-touch, high-trust pricing could fit a narrow set of serious clients."
    },
    {
      "title": "Bundle add-on credits",
      "category": "Experiment",
      "state": "Retired",
      "score": 4,
      "effort": 3,
      "note": "Feels clever but may add more confusion than value."
    }
  ]
};
